...
import 'package:url_launcher/url_launcher.dart'; // مكتبة url_launcher لفتح الرابط
import 'package:shared_preferences/shared_preferences.dart'; // مكتبة SharedPreferences لحفظ المقالات
import 'dart:convert'; // لتحويل المقالات إلى JSON وحفظها
...
class NewsDetailsPage extends StatelessWidget {
  ...
  Future<void> _saveArticle(BuildContext context) async {
    ...
    // التحقق إذا كان المقال موجودًا بالفعل
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: url.isNotEmpty
          ...
          : null, // إذا كان الرابط فارغًا، لا يظهر الزر
